...
use crate::core::consts::DEFAULT_ENERGY;
use crate::core::transforms::{RotationParams, rotate_beam};

use crate::sources::distributions::{
    EnergyDist, SpatialDist, apply_distribution, make_energy, set_annulus,
};
use crate::sources::polarization::{Polarization, make_polarization};
...
mod tests {
    ...
    fn annulus_distribution() {
        use crate::sources::distributions::SpatialDist;
        let source = GeometricSource {
            nrays: 10000,
