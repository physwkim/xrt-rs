...
use crate::math::f0::{F0Coeffs, f0_array, f0_scalar};
use crate::math::interp::interp_linear;

use crate::materials::data::{
...
impl Element {
    ...
    pub fn get_f1f2_scalar(&self, energy: f64) -> Result<Complex64, XrtError> {
        ...
        let f1 = crate::math::interp::interp_linear_scalar(energy, &self.e_table, &self.f1_table);
        let f2 = crate::math::interp::interp_linear_scalar(energy, &self.e_table, &self.f2_table);
