...
use xrt_rs::waves::prepare_wave::{WaveParams, beam_to_diffraction_rays, prepare_wave};
...
fn all_source_types_generate_beams() {
    ...
    let mut bm = xrt_rs::sources::bending_magnet::BendingMagnet::new(
    ...
    // Wiggler source
    let mut wig = xrt_rs::sources::wiggler::Wiggler::new(
    ...
    // Undulator source
    let mut und = xrt_rs::sources::undulator::Undulator::new(
